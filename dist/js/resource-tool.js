...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_Images__ = __webpack_require__(6);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_ImageUploadField__ = __webpack_require__(33);
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__LoadArea__ = __webpack_require__(1);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__UrlArea__ = __webpack_require__(10);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__LoadedFiles__ = __webpack_require__(16);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__Catalog__ = __webpack_require__(22);
    ...
    methods: {
        ...
        uploadRequest: function uploadRequest(file, index) {
            ...
            App.api.request({
                ...
                _this3.$toasted.show(images.length > 1 ? _this3.__('The images was uploaded!') : _this3.__('The image was uploaded!'), { type: 'success' });
            });
        },
        uploadViaUrl: function uploadViaUrl(url) {
            ...
            App.api.request({
                ...
                _this4.$toasted.show(images.length > 1 ? _this4.__('The images was uploaded!') : _this4.__('The image was uploaded!'), { type: 'success' });
            });
        },
        remove: function remove(index) {
            ...
            App.api.request({
                ...
                _this5.$toasted.show(_this5.__('The image was removed!'), { type: 'success' });
            }).catch(function () {
                _this5.loadingRemove = false;
            });
        },
        setMain: function setMain(index) {
            ...
            App.api.request({
                ...
                _this6.$toasted.show(_this6.__('The image was set as main!'), { type: 'success' });
            }).catch(function () {
                _this6.loadingSetMain = false;
            });
        },
        changePositions: function changePositions(images) {
            ...
            App.api.request({
                ...
                _this7.$toasted.show(_this7.__('Images positions were changed'), { type: 'success' });
            }).catch(function () {
                _this7.loading = false;
            });
        }
...
var update = __webpack_require__(3)("40af22cf", content, false, {});
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__ElementForLoad__ = __webpack_require__(18);
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(3)("65c082c0", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__ImageElement__ = __webpack_require__(26);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vuedraggable__ = __webpack_require__(29);
...
var render = function() {
  ...
  return _c(
    _vm.zoom ? "a" : "div",
    {
      ...
      attrs: { href: _vm.zoom, target: "_blank" }
    },
    [
      _vm._t("default"),
      _vm._v(" "),
    ...
    _vm._l(_vm.images, function(image, $i) {
      return _c(
        "image-element",
        {
          key: $i,
          staticClass: "mx-2 mb-4",
          attrs: { main: image.main, zoom: image.url },
          on: {
            remove: function($event) {
              return _vm.$emit("remove", $i)
            },
