...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_Images__ = __webpack_require__(15);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_ImageUploadField__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_ImageUploadField___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__components_ImageUploadField__);



App.booting(function (Vue, router) {
    Vue.component('images-tool', __WEBPACK_IMPORTED_MODULE_0__components_Images___default.a);
    Vue.component('image-upload-field', __WEBPACK_IMPORTED_MODULE_1__components_ImageUploadField___default.a);
});
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__LoadArea__ = __webpack_require__(2);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__UrlArea__ = __webpack_require__(19);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__UrlArea___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__UrlArea__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__LoadedFiles__ = __webpack_require__(25);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__LoadedFiles___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__LoadedFiles__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__Catalog__ = __webpack_require__(34);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__Catalog___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3__Catalog__);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    components: {
        Catalog: __WEBPACK_IMPORTED_MODULE_3__Catalog___default.a,
        LoadedFiles: __WEBPACK_IMPORTED_MODULE_2__LoadedFiles___default.a,
        LoadArea: __WEBPACK_IMPORTED_MODULE_0__LoadArea___default.a,
        UrlArea: __WEBPACK_IMPORTED_MODULE_1__UrlArea___default.a
    },
    ...
    methods: {
        ...
        uploadRequest: function uploadRequest(file, index) {
            ...
            App.api.request({
                ...
                onUploadProgress: function onUploadProgress(progressEvent) {
                    files.forEach(function (file) {
                        return file.progress = progressEvent.loaded / progressEvent.total;
                    });
                }
            }).then(function (_ref2) {
                var _images;
                ...
                _this3.$toasted.show(images.length > 1 ? _this3.__('Изображения были загружены') : _this3.__('Изображение было загружено'), { type: 'success' });
            }).catch(function () {
                _this3.loading = false;
            });
        },
        uploadViaUrl: function uploadViaUrl(url) {
            var _this4 = this;
            ...
            App.api.request({
                ...
                _this4.loadedImages = _this4.loadedImages.filter(function (value, i) {
                    return i !== index;
                });

                (_images2 = _this4.images).push.apply(_images2, _toConsumableArray(images));

                _this4.upload();

                _this4.$toasted.show(images.length > 1 ? _this4.__('Изображения были загружены') : _this4.__('Изображение было загружено'), { type: 'success' });
            }).catch(function () {
                _this4.loading = false;
            });
        },
        remove: function remove(index) {
            ...
            if (!this.fastDelete) {
                if (!confirm(this.__('Вы действительно хотите удалить изображение?'))) return;
            }
            ...
            App.api.request({
                ...
                _this5.loadingRemove = false;

                App.$emit('imageRemoved', image);
                App.$emit('indexRefresh');

                _this5.images = _this5.images.filter(function (value, i) {
                    return i !== index;
                });

                if (image.main && _this5.images.length) _this5.images[0].main = true;

                _this5.$toasted.show(_this5.__('Изображение было удалено'), { type: 'success' });
            }).catch(function () {
                _this5.loadingRemove = false;
            });
        },
        setMain: function setMain(index) {
            ...
            App.api.request({
                ...
                _this6.images.forEach(function (value, i) {
                    if (!value.language || value.language == image.language) {
                        value.main = i === index;
                    }
                });

                _this6.$toasted.show(_this6.__('Главное изображение установлено'), { type: 'success' });
            }).catch(function () {
                _this6.loadingSetMain = false;
            });
        },
        setLanguage: function setLanguage(_ref4) {
            var _this7 = this;

            var index = _ref4.index,
                language = _ref4.language;

            if (this.loadingSetLanguage) return;
            ...
            App.api.request({
                ...
                var count = 0;
                _this7.images.forEach(function (value, i) {
                    if (!value.language || value.language == image.language) {
                        count++;
                    }
                });
                if (count > 1) image.main = false;

                _this7.$toasted.show(_this7.__('Язык установлен'), { type: 'success' });
            }).catch(function () {
                _this7.loadingSetLanguage = false;
            });
        },
        changePositions: function changePositions(images) {
            var _this8 = this;
            ...
            App.api.request({
                ...
                _this8.$toasted.show(_this8.__('Позиции изображений изменены'), { type: 'success' });
            }).catch(function () {
                _this8.loading = false;
            });
        }
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    computed: {
        maxSizePretty: function maxSizePretty() {
    ...
    methods: {
        ...
        checkMimeType: function checkMimeType(file) {
            if (!file.errors) file.errors = [];
        ...
        load: function load(files) {
            ...
            [].concat(_toConsumableArray(files)).forEach(function (file) {
                return _this.checkSize(file) && _this.checkMimeType(file);
            });
  ...
  return _c(
    ...
    [
      _c(
        ...
        {
          staticClass:
            "gallery__load-area__label w-full p-2 flex flex-col items-center bg-white text-blue rounded-sm tracking-wide uppercase border border-grey border-dashed cursor-pointer hover:bg-grey-lighter",
          class: { "gallery__load-area--over": _vm.over }
        },
        [
          _c(
            "div",
            { staticClass: "gallery__load-area__value" },
            [_vm._t("default")],
            2
          ),
          _vm._v(" "),
          _c(
            "div",
            {
              ...
              class: {
                "gallery__load-area__buttons--with-content": _vm.$slots.default
              }
            },
            [
              _c(
              ...
              _c(
                ...
                [
                  _vm._v(
                    "\n                " +
                      _vm._s(_vm.title ? _vm.title : _vm.__("Выберите файл")) +
                      "\n                "
                  ),
                  _vm.maxSize
                    ? _c(
                        "div",
                        { staticClass: "normal-case text-center text-grey" },
                        [
                          _vm._v(
                            "(" +
                              _vm._s(
                                _vm.__("макс.") + " " + _vm.maxSizePretty
                              ) +
                              ")"
                          )
                        ]
              ...
              _vm._v(" "),
              _vm.clear && _vm.$slots.default
                ? _c(
                    "div",
                    {
                      staticClass:
                        "text-grey hover:text-danger text-xl absolute",
                      staticStyle: { top: "1rem", right: "1rem" },
                      on: {
...
Component.options.__file = "resources/js/components/UrlArea.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-4bbd93fe", Component.options)
  } else {
    hotAPI.reload("data-v-4bbd93fe", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
var update = __webpack_require__(4)("40af22cf", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-4bbd93fe\",\"scoped\":false,\"hasInlineConfig\":true}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./UrlArea.vue", function() {
     var newContent = require("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-4bbd93fe\",\"scoped\":false,\"hasInlineConfig\":true}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./UrlArea.vue");
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    created: function created() {
        ...
        App.$on('imageUploaded', function (image) {
            if (typeof image === 'string') _this.url = '';
        });
    }
});
...
var render = function() {
  ...
  return _c(
    "form",
    {
      staticClass: "gallery__url-area flex",
      on: {
        submit: function($event) {
          $event.preventDefault()
          return _vm.$emit("load", _vm.url)
        }
      }
    },
    [
      _c("text-input", {
        ...
        attrs: { placeholder: _vm.__("Вставьте ссылку на файл") },
        model: {
          value: _vm.url,
          callback: function($$v) {
            _vm.url = $$v
      ...
      _c(
        "app-button",
        { staticClass: "gallery__url-area__button", attrs: { submit: "" } },
        [
          _c("i", { staticClass: "fa fas fa-upload mr-2" }),
          _vm._v("\n        " + _vm._s(_vm.__("Загрузить")) + "\n    ")
        ]
      )
    ],
    1
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-4bbd93fe", module.exports)
  }
}
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__ElementForLoad__ = __webpack_require__(27);
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__ProgressBar__ = __webpack_require__(29);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    name: 'ElementForLoad',
    components: { ProgressBar: __WEBPACK_IMPORTED_MODULE_0__ProgressBar___default.a },
    props: {
        loading: {
            type: Boolean,
            default: false
...
var render = function() {
  ...
  var _c = _vm._self._c || _h
  return _vm.value
    ? _c("div", { staticClass: "gallery__element__progress" }, [
        _c("div", { staticClass: "gallery__element__progress__value" }, [
          _vm._v(_vm._s(Math.round(_vm.value)) + "%")
        ]),
        _vm._v(" "),
        _c("div", {
          staticClass: "gallery__element__progress__loaded",
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(4)("65c082c0", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-c9165604\",\"scoped\":false,\"hasInlineConfig\":true}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Catalog.vue", function() {
     var newContent = require("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-c9165604\",\"scoped\":false,\"hasInlineConfig\":true}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Catalog.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__ImageElement__ = __webpack_require__(38);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vuedraggable__ = __webpack_require__(41);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    name: "Catalog",
    components: { ImageElement: __WEBPACK_IMPORTED_MODULE_0__ImageElement___default.a, Draggable: __WEBPACK_IMPORTED_MODULE_1_vuedraggable___default.a },
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    created: function created() {
        if (this.languages) {
            this.languageOptions = this.languages.map(function (item) {
                return {
                    value: item,
    ...
    [
      ...
      _c(
        _vm.zoom ? "a" : "div",
        {
          ...
          attrs: { target: "_blank", href: _vm.zoom }
        },
        [
          _c(
            "div",
          ...
          _vm.zoom
            ? _c("i", {
                staticClass:
                  "fal fa-search-plus gallery__element__overlay__zoom"
              })
            : _vm._e()
        ]
      ),
      ...
      _vm.languages
        ? _c("app-select", {
            staticClass: "gallery__element__language",
            attrs: {
              small: "",
              emptyTitle: "--",
            ...
            on: {
              select: function($event) {
                return _vm.$emit("setLanguage", $event)
              }
            }
          })
        : _vm._e()
    ...
    _vm._b(
      {
        ...
        on: {
          input: function($event) {
            return _vm.$emit("changePositions", $event)
          }
        }
      },
      "draggable",
        ...
        "image-element",
        {
          ...
          on: {
            ...
            setLanguage: function($event) {
              return _vm.$emit("setLanguage", { index: $i, language: $event })
            }
          }
        },
  ...
  return _c(
    ...
    [
      ...
      _c("div", { staticClass: "text-center my-4" }, [
        _vm._v(_vm._s(_vm.__("или")))
      ]),
      _vm._v(" "),
      _c("url-area", { staticClass: "mb-4", on: { load: _vm.uploadViaUrl } }),
      _vm._v(" "),
      ...
      _c("div", { staticClass: "my-4" }, [
        _c(
          ...
          [
            _vm._v(
              _vm._s(_vm.__("Удаление без подтверждения")) + "\n            "
            ),
            _c("switch-input", {
              staticClass: "ml-4",
              model: {
                value: _vm.fastDelete,
                callback: function($$v) {
                  _vm.fastDelete = $$v
                },
                expression: "fastDelete"
              }
            })
          ],
          1
      ...
      _vm._v(" "),
      _c("catalog", {
        attrs: { images: _vm.images, languages: _vm.field.languages },
        on: {
          remove: _vm.remove,
          changePositions: _vm.changePositions,
          setMain: _vm.setMain,
...
Component.options.__file = "resources/js/components/ImageUploadField.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-0edf92ee", Component.options)
  } else {
    hotAPI.reload("data-v-0edf92ee", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
var render = function() {
  ...
  return _c(
    ...
    [
      _vm.label
        ? _c("div", { staticClass: "form__group__label mt-0" }, [
      ...
      _c(
        "load-area",
        {
          attrs: { maxSize: _vm.maxSize, accept: _vm.accept, clear: _vm.clear },
          on: {
            load: function($event) {
        ...
        [_vm._t("default", null, { image: _vm.value })],
        2
      )
    ],
    1
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-0edf92ee", module.exports)
  }
}
